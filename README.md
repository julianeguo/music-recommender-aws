...
### To run the app:
*Note: Unfortunately, the AWS account that hosts the app was recently terminated on 4/5/2026 because the free credits ran out. Still, check out the code in the repo, and the demo video here: [demo video](URL)*
